    ...
    <div class="id-card">
        ...
        <div class="photo">
            {{-- <img src="{{ $record->profile_image ?? 'http://try.test/default_images/me.jpg' }}" alt="profile"> --}}
                    <img src="{{ 'http://enrollment-highschool.webactivities.online/'.$record->profile_image ?? 'http://enrollment-highschool.webactivities.online/default_images/me.jpg' }}" alt="profile">
        </div>
